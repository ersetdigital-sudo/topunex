          ...
          <nav className="mx-auto max-w-6xl px-4 sm:px-6 h-16 flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div className="hidden md:flex items-center gap-5 text-sm text-[#9C9791]">
                <Link href="/admin" className="hover:text-white transition">Games</Link>
                <Link href="/admin/settings" className="hover:text-white transition">Settings</Link>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <a href="/" target="_blank" className="text-sm text-[#9C9791] hover:text-white transition">View Site ↗</a>
              <form action="/api/auth/signout" method="post">
                <button type="submit" className="text-sm text-[#9C9791] hover:text-white transition">Logout</button>
              </form>
            </div>
          </nav>
        </header>
